...
uint32 poweroff_timer_clock_accuracy =
    100000; /* 100,000 microseconds resolution -- should use very little clock
               time with low resolution */
...
void TIM_AppInit(void) {
  ...
  */
  ...
  /*
  ** Initialize Timer for poweroff -- attaches to
  *timer_callback_poweroff_system()
  */
  ...
  uint32 poweroff_interval = 10000000; // 10 seconds in microseconds -- function
                                       // should never be called twice, but this
                                       // is a failsafe of sorts.
 ...
 * * * * * * * * * * * * * * **/
/*                                                                                                          */
/* timer_callback_poweroff_system(uint32 poweroff_timer_id) -- Poweroff the
 * system, called by 				*/
/*															   OSAL
 * Timer at time defined in tim_app.h 	    */
/*                                                                                                          */
/* * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * *
 * * * * * * * * * * * * * * **/
