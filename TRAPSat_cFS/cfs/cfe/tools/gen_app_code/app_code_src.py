...
""" % (tmpStr, tmpStr, lcApp, lcApp, lcApp, lcApp, lcApp, lcApp)
...
** End of file %s_app.h
**=====================================================================================*/
    """ % (lcApp, lcApp, ucApp,  ucApp, ucApp, ucApp, ucApp, ucApp, ucApp, ucApp, \
           ucApp, ucApp, ucApp, ucApp, ucApp, ucApp, tmpStr, lcApp)
...
int32 %s_RcvMsg(int32 iBlocking)
{
    ...
    """ % (ucApp, ucApp, ucApp, ucApp, ucApp, ucApp, ucApp, g_Owner, g_Date, \
