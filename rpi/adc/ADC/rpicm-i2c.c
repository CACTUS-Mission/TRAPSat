...
int rpicm_i2c_open_bus(int i2c_bus)
{
	...
	char i2c_bus_id = (char) i2c_bus; // This conversion works fine because our only possible bus numbers are 0 through 2
...
int main(int argc, char *argv[])
{
	...
	else
	{
		...
		else
		{
			 ...
			 * Created by combining the two bytes from the read buffer into a single 16 bit result
			 */
